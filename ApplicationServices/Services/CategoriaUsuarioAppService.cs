...
namespace ApplicationServices.Services
{
    public class CategoriaUsuarioAppService : AppServiceBase<CATEGORIA_USUARIO>, ICategoriaUsuarioAppService
    {
        ...
        public CATEGORIA_USUARIO CheckExist(CATEGORIA_USUARIO ag, Int32 idAss)
        {
            CATEGORIA_USUARIO item = _baseService.CheckExist(ag, idAss);
            return item;
        }
        ...
        public Int32 ValidateDelete(CATEGORIA_USUARIO item, USUARIO usuario)
        {
            try
            {
                ...
                LOG log = new LOG
                {
                    ...
                    LOG_TX_REGISTRO = "Categoria de Usuário: " + item.CAUS_NM_NOME
                };
