    ...
    public class AdministracaoController : Controller
    {
        ...
        public ActionResult FiltrarUsuario(USUARIO item)
        {
            try
            {
                ...
                Int32 volta = baseApp.ExecuteFilter(item.CAUS_CD_ID, item.USUA_NM_CARGO, item.USUA_NM_NOME, item.USUA_NM_LOGIN, item.USUA_NM_EMAIL, item.USUA_NR_CPF, idAss, out listaObj);
        ...
        public ActionResult IncluirUsuario(UsuarioViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (volta == 1)
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0012", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 2)
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0013", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 3)
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0022", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 4 )
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0023", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 5)
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0027", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 6)
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0028", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
                    if (volta == 7)
                    {
                        ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0029", CultureInfo.CurrentCulture));
                        return View(vm);
                    }
        ...
        public ActionResult UploadFotoUsuario(HttpPostedFileBase file)
        {
            ...
            {
                ModelState.AddModelError("", GED_Resources.ResourceManager.GetString("M0021", CultureInfo.CurrentCulture));
            }
            return RedirectToAction("VoltarAnexoUsuario");
        }
        ...
        public ActionResult GerarRelatorioLista()
        {
            ...
            foreach (USUARIO item in lista)
            {
                ...
                table.AddCell(cell);
                cell = new PdfPCell(new Paragraph(item.USUA_NM_CARGO, meuFont))
                {
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                    HorizontalAlignment = Element.ALIGN_LEFT
                };
        ...
        public ActionResult GerarRelatorioDetalhe(Int32 id)
        {
            ...
            cell = new PdfPCell(new Paragraph("Cargo: " + aten.USUA_NM_CARGO, meuFont));
            cell.Border = 0;
            cell.Colspan = 1;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
